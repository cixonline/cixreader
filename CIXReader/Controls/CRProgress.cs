...
// 
// Author: Nitoc3
// Derived from the Circular-Progress-Indicator on CodeProject.
// 
// Created: 16/09/2013 3:21 PM
//  
...
namespace CIXReader.Controls
{
    ...
    /// </summary>
    public sealed partial class CRProgress : Control
    {
        /// <summary>
        ...
        private Color _circleColour = Color.FromArgb(20, 20, 20);
        ...
        /// <summary>
        /// Gets or sets the base colour for the circles.
        /// </summary>
        [DefaultValue(typeof (Color), "20, 20, 20")]
        [Description("Gets or sets the base colour for the circles.")]
        [Category("Appearance")]
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                int alphaValue = (255.0F*(i/(float) _numberOfVisibleCircles)) > 255.0
                    ? 0
                    : (int) (255.0F*(i/(float) _numberOfVisibleCircles));
                int alpha = _stopped ? (int) (255.0F*(1.0F/8.0F)) : alphaValue;

                Color drawColor = Color.FromArgb(alpha, CircleColour);

                using (SolidBrush brush = new SolidBrush(drawColor))
                {
                    float sizeRate = 4.5F/CircleSize;
        ...
        /// <summary>
        /// Resizes the progress indicator. We use this to ensure the new size
        /// is constrained to a square.
        /// </summary>
        ...
        /// <summary>
        /// Respond to explicit size changes on the progress indicator. We use this
        /// to ensure the new size is constrained to a square.
        /// </summary>
        /// <param name="e">Generic event arguments</param>
        ...
        private string GetDrawText()
        {
            ...
            return _showPercentage ? percent : string.Empty;
        }
