...
namespace AppLimit.NetSparkle
{
    ...
    public delegate void InstallAndRelaunchOperation(Object sender, EventArgs args);
    ...
    public class Sparkle : IDisposable
    {
        ...
        /// <summary>
        /// This event will be raised just before we install and relaunch
        /// </summary>
        public event InstallAndRelaunchOperation installAndRelaunch;
        ...
        internal void NotifyInstallAndRelaunch()
        {
