...
#Region "Add Word to Dictionary"
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        If Not _DisableConfirmationPrompt Then
            ...
            dlgResult = MessageBox.Show("This will add the word to the dictionary." & vbNewLine & "Continue?", "Add Word to Dictionary", MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk)
